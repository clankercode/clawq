...
<MermaidDiagram
  diagram={`flowchart TD
    ...
    EXE["clawq executable<br/>main.ml + cmdliner"]
...
| `daemon.ml` | Supervisor: gateway + telegram + discord + slack_socket, signal handling, config file watcher (10s mtime poll + SIGHUP), EC process lifecycle |
