...
| Callsite | Owner Module | Credential | Header/Usage | Redaction | Risk | Enforceability |
|----------|--------------|------------|--------------|-----------|------|----------------|
| `config_loader.ml:1093-1104` | `Config_loader` | `search_api_key` | Passed to web search provider | None | HIGH | MISSING |
...
| Callsite | Owner Module | Credential | Header/Usage | Redaction | Risk | Enforceability |
|----------|--------------|------------|--------------|-----------|------|----------------|
| `config_loader.ml:1118-1141` | `Config_loader` | `zai_mcp.key` | Bearer token for Z.ai API | None | HIGH | MISSING |
