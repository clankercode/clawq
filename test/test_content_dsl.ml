let test_render_paragraph () =
  ...
  Alcotest.(check bool)
    "contains hello" true
    (Test_helpers.string_contains result "hello");
  Alcotest.(check bool)
    "contains bold world" true
    (Test_helpers.string_contains result "**world**")
...
let test_render_code_block () =
  ...
  Alcotest.(check bool)
    "has code fence" true
    (Test_helpers.string_contains result "```ocaml");
  Alcotest.(check bool)
    "has content" true
    (Test_helpers.string_contains result "let x = 1")
...
let test_render_tool_entry_done () =
  ...
  Alcotest.(check bool)
    "has checkmark" true
    (Test_helpers.string_contains result "\xe2\x9c\x93");
  Alcotest.(check bool)
    "has tool name" true
    (Test_helpers.string_contains result "file_read");
  Alcotest.(check bool)
    "has summary" true
    (Test_helpers.string_contains result "src/main.ml");
  Alcotest.(check bool)
    "has timing" true
    (Test_helpers.string_contains result "2.5s");
  Alcotest.(check bool)
    "has preview" true
    (Test_helpers.string_contains result "42 lines")
...
let test_render_tool_entry_failed () =
  ...
  Alcotest.(check bool)
    "has x mark" true
    (Test_helpers.string_contains result "\xe2\x9c\x97");
  Alcotest.(check bool)
    "has error" true
    (Test_helpers.string_contains result "exit code 1")
...
let test_render_tool_entry_running () =
  ...
  Alcotest.(check bool)
    ...
    (Test_helpers.string_contains result "\xe2\x97\x89");
  Alcotest.(check bool)
    "has connector" true
    (Test_helpers.string_contains result "\xE2\x94\x97")
...
let test_render_collapsed_tools () =
  ...
  Alcotest.(check bool)
    "has count" true
    (Test_helpers.string_contains result "5 tools completed")
...
let test_render_progress_bar () =
  ...
  Alcotest.(check bool)
    "has progress" true
    (Test_helpers.string_contains result "4/8")
...
let test_render_thinking_preview () =
  ...
  Alcotest.(check bool)
    ...
    (Test_helpers.string_contains result "\xF0\x9F\x92\xAD");
  Alcotest.(check bool)
    "has text" true
    (Test_helpers.string_contains result "analyzing code structure")
...
let test_render_html_connector () =
  ...
  Alcotest.(check bool)
    "has HTML bold" true
    (Test_helpers.string_contains result "<b>hello</b>");
  Alcotest.(check bool)
    "has HTML code" true
    (Test_helpers.string_contains result "<code>world</code>")
...
let test_render_document_multi_block () =
  ...
  Alcotest.(check bool)
    "has collapsed" true
    (Test_helpers.string_contains result "3 tools completed");
  Alcotest.(check bool)
    "has tool" true
    (Test_helpers.string_contains result "file_read")
...
let test_render_separator () =
  ...
  Alcotest.(check bool)
    ...
    (Test_helpers.string_contains result "\xE2\x94\x81")
...
let test_render_question_block_telegram () =
  ...
  Alcotest.(check bool)
    "has HTML bold" true
    (Test_helpers.string_contains result "<b>Pick one</b>");
  Alcotest.(check bool)
    "has option 1 with code" true
    (Test_helpers.string_contains result "<code>1</code>. Alpha");
  Alcotest.(check bool)
    "has option 2 with code" true
    (Test_helpers.string_contains result "<code>2</code>. Beta");
  Alcotest.(check bool)
    "has italic instruction" true
    (Test_helpers.string_contains result "<i>Reply with number or text</i>")
...
let test_render_question_block_discord () =
  ...
  Alcotest.(check bool)
    ...
    (Test_helpers.string_contains result "**Confirm?**");
  Alcotest.(check bool)
    "has hint" true
    (Test_helpers.string_contains result "This is important");
  Alcotest.(check bool)
    "has instruction" true
    (Test_helpers.string_contains result "Reply yes/no")
...
let test_render_question_block_plain () =
  ...
  Alcotest.(check bool)
    ...
    (Test_helpers.string_contains result "How many?");
  Alcotest.(check bool)
    "has instruction (plain, no formatting)" true
    (Test_helpers.string_contains result "Reply with a number")
...
let test_render_question_block_no_options () =
  ...
  Alcotest.(check bool)
    "has question" true
    (Test_helpers.string_contains result "Enter text");
  Alcotest.(check bool)
    "has hint" true
    (Test_helpers.string_contains result "hint here")
