let templates : (string * string) list =
  [
    ( "EGO.md",
      "# EGO\n\n" ^ "## Mission\n"
      ^ "Ship precise, minimal, verified engineering changes aligned with this \
    ...
    ( "USER.md",
      "# USER\n\n"
      ^ "Describe user preferences that affect implementation choices, \
    ...
    ( "TOOLS.md",
      "# TOOLS\n\n"
      ^ "Workspace-local notes: hostnames, service names, scripts, and \
         operational caveats.\n" );
    ( "HEARTBEAT.md",
